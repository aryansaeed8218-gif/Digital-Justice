...
st.markdown(
    ...
    .stApp {
        background: linear-gradient(180deg, #faf9f6 0%, #f5f5f2 52%, #eef1f0 100%);
        color: #252525;
    }
    ...
    .stApp::before {
        ...
        z-index: 0;
        opacity: .55;
        background: radial-gradient(ellipse at 50% 100%, transparent 0 32%, rgba(11,31,51,.045) 32.4% 33%, transparent 33.5% 41%, rgba(200,164,93,.065) 41.4% 42%, transparent 42.5% 50%, rgba(11,31,51,.040) 50.4% 51%, transparent 51.5% 59%, rgba(200,164,93,.050) 59.4% 60%, transparent 60.5% 100%);
        transform: rotate(-2deg) scale(1.12);
    }

    /* ---------- Central Digital Justice watermark ---------- */
    .watermark-container {
        position: fixed; left: 50%; top: 54%;
        width: min(500px, 58vw); height: min(500px, 58vw);
    ...
    .watermark-ring {
        ...
        border: 2px solid rgba(200,164,93,.65); border-radius: 50%; box-sizing: border-box;
    }
    .watermark-ring::before, .watermark-ring::after {
        position: absolute; left: 50%; transform: translateX(-50%); width: 92%;
        text-align: center; color: #c8a45d; font-size: clamp(8px, .82vw, 12px);
        font-weight: 800; letter-spacing: .12em; white-space: nowrap;
    }
    .watermark-ring::before {
        content: "LEGAL-TECH  •  RAG  •  DIGITAL RIGHTS  •  PRIVACY  •  SECURITY  •  JUSTICE"; top: -28px;
    }
    .watermark-ring::after {
        content: "LEGAL-TECH  •  RAG  •  DIGITAL RIGHTS  •  PRIVACY  •  SECURITY  •  JUSTICE"; bottom: -28px;
    }
    .watermark-scale {
        position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%);
        width: 135px; height: 135px; border-radius: 50%;
        display: flex; align-items: center; justify-content: center;
        border: 1px solid rgba(200,164,93,.65); color: #c8a45d;
        font-size: 62px; opacity: .9; box-sizing: border-box;
    }
    .watermark-title {
        position: absolute; bottom: 24%; color: #0b1f33;
        font-size: clamp(14px, 1.7vw, 21px); font-weight: 900;
    ...
    @media (max-width: 700px) {
        .watermark-container { width: 320px; height: 320px; }
        .watermark-scale { width: 90px; height: 90px; font-size: 44px; }
        .watermark-title { font-size: 11px; }
        .watermark-ring::before, .watermark-ring::after { width: 100%; font-size: 6px; letter-spacing: .06em; }
        .watermark-ring::before { top: -20px; }
        .watermark-ring::after { bottom: -20px; }
    }
...
<div class="watermark-container" aria-hidden="true">
    ...
    <div class="watermark-scale">⚖️</div>
    <div class="watermark-title">DIGITAL JUSTICE</div>
</div>
""",
    unsafe_allow_html=True,
)
